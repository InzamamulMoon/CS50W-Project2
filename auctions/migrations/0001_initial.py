# Generated by Django 4.1 on 2023-07-12 21:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Categories', models.CharField(choices=[('FA', 'Fashion'), ('TY', 'Toys'), ('EL', 'Electronics'), ('HO', 'Home')], default='FA', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('listing', models.ManyToManyField(related_name='item', to='auctions.listings')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treasure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.listings')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('commenters', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='individual', to=settings.AUTH_USER_MODEL)),
